...
public class Config {
    ...
    private static void loadDefaultConfig() {
        ...
        setDefaultConfig("messages.twofa-not-set", "<red>Kapcsold be az IP cím alapján történő kétlépcsős azonosítást a Discord szerverünkön! Használd a /setip parancsot!");
        saveConfig();
    }
